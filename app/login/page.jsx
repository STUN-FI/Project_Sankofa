...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen bg-slate-50 text-slate-900">
      ...
      <div className="flex flex-1 flex-col justify-start px-6 pt-24 pb-12 lg:w-2/5 lg:flex-none lg:justify-center lg:px-20 lg:pt-12 xl:px-24 bg-white shadow-2xl z-10">
